...
class mazePic:
    def __init__(self,maze):
        self.wallThickness=1#cant change this yet everything is written so that it moves correctly but the walls are still only 1 thick
    ...
    def fill(self,coord,color):
        ...
        for i in xrange(self.cellSize):
            for j in xrange(self.cellSize):
